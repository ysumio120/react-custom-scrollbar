...
var ScrollWrapper = function (_React$Component) {
  ...
  _createClass(ScrollWrapper, [{
    ...
    value: function getVisibleDimen() {
      var visibleWidth = this.scrollAreaContent ? Math.round(this.scrollAreaContent.getBoundingClientRect().width - this.state.rightScrollWidth) : 0;
      var visibleHeight = this.scrollAreaContent ? Math.round(this.scrollAreaContent.getBoundingClientRect().height - this.state.bottomScrollWidth) : 0;
    ...
    value: function getContentDimen() {
      var contentWidth = this.scrollAreaContent ? this.scrollAreaContent.scrollWidth : 0;
      var contentHeight = this.scrollAreaContent ? this.scrollAreaContent.scrollHeight : 0;
    ...
    value: function render() {
      ...
      var wrapperStyle = this.props.autoHeight ? _util2.default.merge(this.props.wrapperStyle, { height: "auto" }) : this.props.wrapperStyle;
      ...
      var _state = this.state,
          rightScrollWidth = _state.rightScrollWidth,
          bottomScrollWidth = _state.bottomScrollWidth;


      var contentStyle = this.props.autoHeight ? {
